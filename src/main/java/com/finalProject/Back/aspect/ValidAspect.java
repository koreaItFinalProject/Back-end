...
public class ValidAspect {
    ...
    public void ValidSignupDto2(Object[] args , BeanPropertyBindingResult bindingResult){
        for(Object arg : args){
            if(arg.getClass() == ReqOwnerSignupDto.class){
                ReqOwnerSignupDto dto = (ReqOwnerSignupDto) arg;
